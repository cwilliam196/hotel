              ...
              <table class="table align-items-center mb-0">
                <thead>
                  <tr>
                    ...
                    <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">number room</th>
                    <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">facilities</th>
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="d-flex px-2 py-1">
                        ...
                        <div class="d-flex flex-column justify-content-center">
                          <h6 class="mb-0 text-sm">{{$r->number}}</h6>
                        </div>
                      </div>
                    </td>
                    ...
                    <td>
                      <div class="d-flex px-2 py-1">
                        <div class="d-flex flex-column justify-content-center">
                          <h6 class="mb-0 text-sm">{{$r->facilities}}</h6>
                        </div>
                      </div>
                    </td>
                    <td>
                        <div class="d-flex flex-column justify-content-center">
                            <h6 class="mb-0 text-sm">Rp. {{number_format($r->cost,2,',','.')}}</h6>
                          </div>
                    </td>
                    ...
                    <td class="text-xs font-weight-bold align-middle text-center">
                      <span class="my-2 text-xs">
                        <a href="room/{{$r->id}}/edit" class="mx-3" data-bs-toggle="tooltip" data-bs-original-title="Edit Room">
